...
(function (jq) {
    ...
    posterTvGrid.prototype = {
        reset: function (options) {
            ...
            this.preLeft = 0;
            this.nextLeft = this.options.width - 554;
            this.preNLeft = -554;
            this.nextNLeft = this.options.width;
            this.pageNowLeft = (this.options.width - 675) / 2
            this.drawContent();
        },
        drawContent: function () {
            this.parent.empty();
            this.parent.css({width: this.options.width + "px", height: "444px", position: "relative"});
...
//				unitItem += '<span class="rightShadow"></span>';
        ...
        initBottomNav: function () {
            ...
            //工厂设备地下文字
            $('.cf-text-main').find('span').removeClass('c-on');
            $('.cf-text-main').find('span').eq(this.pageNow - 1).addClass('c-on');
