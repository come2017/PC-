        ...
        return this.each(function() {
                ...
                if (!m) {
                    ...
                    if (b.thumb) {
                        if (b.thumbDirection == "Y") {
                            ...
                            C.children(":eq(0)").children("li").children("div").removeClass("cur");
                            C.children(":eq(0)").children("li:eq(" + w + ")").children("div").addClass("cur")
                        } else {
            ...
            if (b.thumb) {
                ...
                C.children(":eq(0)").children().each(function(L) {
                    ...
                    var K = '<li><div class="imgWrap"><img src="' + N + '" alt="' + I + '" /></div><div class="opacity"></div><div class="textDesc"><div class="title"><a href="' + J + '" target="_blank">' + I + '</a></div><div class="text">' + M + "</div></div></li>";
                    a(this).data("data", L);
                    q.append(K)
                });
                C.children(":eq(0)").children("li:eq(" + h + ")").children("div").addClass("cur")
            } else {
                g.hide().remove()
            }
