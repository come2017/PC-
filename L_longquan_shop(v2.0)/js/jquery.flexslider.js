(function($) {
			...
			if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
				...
				if (!fade) {
					...
					if (false && slider.transitions) {
						...
						*/
						slider.container.animate(slider.args, {duration: slider.vars.animationSpeed, easing: slider.vars.easing, complete: function() {
							slider.wrapup(dimension)
						}});
					}
				} else {
	...
	$.fn.flexslider = function(options) {
		...
		if (typeof options === "object") {
			...
			case "prev":
			case "previous":
				$slider.flexAnimate($slider.getTarget("prev"), false);
				break;
			default:
