 ...
 */
  var _globalConfig = {
    swfPath: '/com/imgs/ZeroClipboard.swf',//_getDefaultSwfPath(),
...
ZeroClipboard.config({'swfPath':'/com/imgs/ZeroClipboard.swf','title':'点击复制'});

//绑定复制
function bindCopy(jqCopy){
	if(window.clipboardData){
		jqCopy.each(function(i) {
			$(this).click(function(){
